...
public class KegiatanPkm_Activity extends AppCompatActivity
        implements KegiatanAdapter.ContactsAdapterListener{
    Spinner spBulan;
    FloatingActionButton btnAdd;
    String idUser;
    private RecyclerView recyclerView;
    private List<KegiatanResponse.DataResult> kegiatanList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kegiatan_pkm);
        header();
        initView();
        initPreferences();
        initSpinner();
    ...
    void header(){
        // toolbar fancy stuff
        getSupportActionBar().setTitle("Kegiatan PKM");
    ...
    void recyclerView(){
        ...
        mAdapter = new KegiatanAdapter(this, kegiatanList, this);
    ...
    void getKegiatan(String id, String bulan){
        ...
        client.getServies().getKegiatan(id, bulan,"get").enqueue(new Callback() {
            @Override
            public void onResponse(Call call, Response response) {
                if (response.isSuccessful()){
                    ...
                    if (responseModel.getStatus().equals("sukses")) {
                        ...
                        List<KegiatanResponse.DataResult> result = responseModel.getData();
                        kegiatanList.clear();
    ...
    @Override
    public void onContactSelected(KegiatanResponse.DataResult contact) {
        Toast.makeText(getApplicationContext(), "Selected: " + contact.getJenis() + ", "
