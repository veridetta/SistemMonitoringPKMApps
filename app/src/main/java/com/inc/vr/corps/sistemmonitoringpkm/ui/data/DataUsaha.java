package com.inc.vr.corps.sistemmonitoringpkm.ui.data;
...
import com.inc.vr.corps.sistemmonitoringpkm.adapter.UsahaAdapter;
...
public class DataUsaha extends AppCompatActivity
        implements UsahaAdapter.ContactsAdapterListener{
    Spinner spBulan;
    String idUser;
    private RecyclerView recyclerView;
    private List<UsahaResponse.DataResult> dataResultList;
    ...
    void recyclerView(){
        ...
        mAdapter = new UsahaAdapter(this, dataResultList, this);
    ...
    void initSpinner(){
        ...
        spBulan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                getKegiatan(idUser,String.valueOf(i+1));
            }
    ...
    void getKegiatan(String id, String bulan){
        ApiClient client = new ApiClient();
        SweetAlertDialog sweetAlertDialog = new SweetAlertDialog(this, SweetAlertDialog.PROGRESS_TYPE);
        sweetAlertDialog.setTitleText("Loading");
        sweetAlertDialog.setCancelable(false);
        sweetAlertDialog.show();
        client.getServies().getUsaha(id, bulan,"get").enqueue(new Callback() {
            @Override
            public void onResponse(Call call, Response response) {
                if (response.isSuccessful()){
                    //jika login berhasil
                    UsahaResponse responseModel = (UsahaResponse) response.body();
                    if (responseModel.getStatus().equals("sukses")) {
                        ...
                        List<UsahaResponse.DataResult> result = responseModel.getData();
                        dataResultList.clear();
                        dataResultList.addAll(result);
    ...
    @Override
    public void onContactSelected(UsahaResponse.DataResult contact) {
        Toast.makeText(getApplicationContext(), "Selected: " + contact.getName() + ", "
